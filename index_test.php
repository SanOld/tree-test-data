...
$tree_html_0 = $tree_html->build_tree($lang, 0);
$tree_html_1 = $tree_html->build_tree($lang, 1);
$tree_html_2 = $tree_html->build_tree($lang, 2);
...
<!--    <script type="text/javascript" src="js/jstree.min.js"></script>-->
   <!-- <script type="text/javascript" src="js/alertify.min.js"></script>-->
	...
	{
	?>
		<script type="text/javascript" src="js/tree_no_drag_test.js?<?php echo filemtime('js/tree_no_drag_test.js');?>"></script>
	<?php
	}
	?>
...
<?php } ?>
<div class="tests" style="position: absolute;
    width: 600px;
    height: 500px;
    top: 20px;
    left: 350px;
