...
<div>
    ...
    <div class="">
      <label>
        <input type="checkbox" class = "category_id_search" value="false" data-i18n="tree_search_in_catalog_">
		<span style="font: normal; font-weight: 100;" data-i18n="tree_search_in_catalog"></span>
